...
<sf:override name="pathString">清单报表&gt;&gt;生存金预算清单</sf:override>
...
<input type="hidden" name="ibatisSqlId" value=".planForSurvCoverListQuery" />
<input type="hidden" name="sheetName" value="生存金预算清单" />
<input type="hidden" id="listCode" name="listCode" value="13" />		
<table class="layouttable">
   ...
   <tr>
      <td width="10%" class="layouttable_td_label">
                           应领起止时间范围：<span class="requred_font">*</span>
      </td>
      <td width="50%" class="layouttable_td_widget">
