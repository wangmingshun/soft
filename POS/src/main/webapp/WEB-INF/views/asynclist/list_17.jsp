...
<sf:override name="pathString">清单报表&gt;&gt;作业环节时效清单</sf:override>
...
<input type="hidden" name="ibatisSqlId" value=".operationTimeEffectQuery" />
<input type="hidden" name="sheetName" value="作业环节时效清单" />
<input type="hidden" id="listCode" name="listCode" value="17" />
<table class="layouttable">
    ...
    <tr>
	      <td width="10%" class="layouttable_td_label">
	                          保全受理日期范围：<span class="requred_font">*</span>
	      </td>
	      <td width="50%" class="layouttable_td_widget">
    ...
    <tr>
	     ...
	     <td width="50%" class="layouttable_td_widget">
	         <input type="text" name="operUserId" />
	     </td>
	     <td align="right">
