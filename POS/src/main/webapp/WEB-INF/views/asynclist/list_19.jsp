...
<sf:override name="pathString">清单报表&gt;&gt;客服信函打印清单</sf:override>
...
<sf:override name="content">
	...
	<input type="hidden" name="sql" value="clientNoticeQuery" />
	<input type="hidden" name="sheetName" value="客服信函打印清单" />
	<input type="hidden" id="listCode" name="listCode" value="19" />
	<table class="layouttable">
	   <tr>
		     <td width="10%" class="layouttable_td_label">保单机构：<span class="requred_font">*</span></td>
	    ...
	    <tr>
		      <td width="10%" class="layouttable_td_label">信函类型：</td>
		      <td width="50%" class="layouttable_td_widget">
                <select name="noteType">
                 <c:forEach items="${CodeTable.posTableMap.POS_NOTE_TYPE}" var="item">
	    ...
	    <tr>
		      <td width="10%" class="layouttable_td_label">打印时间范围：<span class="requred_font">*</span></td>
		      <td width="50%" class="layouttable_td_widget">
