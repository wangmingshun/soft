...
<sf:override name="pathString">清单报表&gt;&gt;保单冻结清单</sf:override>
...
<input type="hidden" name="ibatisSqlId" value=".queryFreezeList" />
	<input type="hidden" name="sheetName" value="保单冻结清单" />
	<input type="hidden" id="listCode" name="listCode" value="27" />
	<table class="layouttable">
	     ...
	     <tr>   
	        <td width="10%" class="layouttable_td_label">
	                               保单冻结时间范围：<span class="requred_font">*</span>
	        </td>
