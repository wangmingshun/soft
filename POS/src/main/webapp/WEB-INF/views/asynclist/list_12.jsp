...
<sf:override name="pathString">清单报表&gt;&gt;保全回退/撤销清单</sf:override>
...
<input type="hidden" name="sql" value="posToRollbackListQuery" />
<input type="hidden" name="sheetName" value="保全回退/撤销清单" />
<input type="hidden" id="listCode" name="listCode" value="12" />
