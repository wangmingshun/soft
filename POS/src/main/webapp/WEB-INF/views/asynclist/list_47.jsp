...
<sf:override name="pathString">清单报表&gt;&gt;POS系统权限清单</sf:override>
...
<sf:override name="content">
	...
	<input type="hidden" name="sheetName" value="POS系统权限清单" />
	<input type="hidden" id="listCode" name="listCode" value="47" />
