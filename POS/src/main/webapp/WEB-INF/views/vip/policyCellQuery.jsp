...
<sf:override name="pathString">清单报表&gt;&gt;保单层清单查询</sf:override>
...
<input type="hidden" name="ibatisSqlId" value=".queryVipPolicyCellInfo" />
<input type="hidden" name="sheetName" value="保单层清单查询" />
...
<table class="layouttable">
	   <tr>
	    ...
	    <tr class="isShow">
		      ...
		      <td width="50%" class="layouttable_td_widget">
				     <input type="text" name="startDate" class="Wdate {required:function(){if($('#dataType').val()=='0'){return false;}return true;},messages:{required:' 请输入开始日期'}} inputPara" />
				     至
				     <input type="text" name="endDate" class="Wdate {required:function(){if($('#dataType').val()=='0'){return false;}return true;},messages:{required:' 请输入结束日期'}} inputPara" />
		      </td>
	     </tr>
	</table>
	<hr class="hr_default"/>
