...
<sf:override name="pathString">清单报表&gt;&gt;贷款清单</sf:override>
...
<sf:override name="content">
	...
	<input type="hidden" name="ibatisSqlId" value=".loanListQuery" />
	<input type="hidden" name="sheetName" value="贷款清单" />
	<input type="hidden" id="listCode" name="listCode" value="35" />
