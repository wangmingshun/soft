...
<sf:override name="pathString">清单报表&gt;&gt;契撤清单</sf:override>
...
<sf:override name="content">
	...
	<input type="hidden" name="ibatisSqlId" value=".hesitateListQuery" />
	<input type="hidden" name="sheetName" value="契撤清单" />
	<input type="hidden" id="listCode" name="listCode" value="34" />
