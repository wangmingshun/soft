...
<sf:override name="pathString">清单打印&gt;&gt;打印&gt;&gt;保单打印</sf:override>
...
<sf:override name="content">
	<sfform:form id="fm" action="policy_single_submit.do" class="noBlockUI">
		<input type="hidden" name="noBackButton" value="${param.noBackButton}" />
	  ...
	  <table class="layouttable">	  		  
		  ...
		  <td width="10%" class="layouttable_td_label">
		     ...
		     <td width="50%" class="layouttable_td_widget">
		          <input type="text" name="policyNo" value="${param.policyNo}" class="input_text {required:true}"/>
		     </td>
		     <td align="right">
	           <a  class='easyui-linkbutton' href="javascript:void(0)" onclick="$('#fm').submit();return false;"  iconCls="icon-ok" id="confirm">确定</a>
	           <c:if test="${param.noBackButton ne 'Y'}">
