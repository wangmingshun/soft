...
<sf:override name="pathString">清单打印&gt;&gt;打印&gt;&gt;通知书逐单打印</sf:override><sf:override name="head">
		...
		$(function(){
			...
			$("#policyNo").change(function(){
				...
				if(policyNo && ["1", "2"].indexOf(noticeType) != -1) {
					...
					$.post("${ctx}print/queryNoteYearOptions.do", {"policyNo":policyNo, "noticeType" : noticeType}, function(data){
	...
	<table class="layouttable">	
	   <tr>
	    ...
	    <tr>
		      ...
		      <td width="50%" class="layouttable_td_widget">
				    <sfform:select path="noticeType" id="noticeType" items="${CodeTable.posTableMap.POS_NOTE_TYPE}" itemLabel="description" itemValue="code"
