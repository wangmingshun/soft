...
},plugins:["linkbutton","menu","menubutton","splitbutton","tree","combobox","combotree","numberbox","validatebox","numberspinner","timespinner","calendar","datebox","layout","panel","datagrid","tabs","accordion","window","dialog"],parse:function(_154){
var aa=[];
...
_16f.isLoaded=false;
var url =getRandomTermUrl(_16f.options.href);
...
//ie6下panel的遮罩 2011-08-17  begin
_19a.panel.bgiframe();
//ie6下panel的遮罩 2011-08-17 end
});
};
...
//ie6下拉列表的遮罩 2011-08-08  begin
win.parent().bgiframe();
//ie6下拉列表的遮罩 2011-08-08 end
if(_1af.mask){
...
//修复IE6.0下提示标签，被select框挡住BUG Begin
tip.find(".validatebox-tip-content").bgiframe();
tip.find(".validatebox-tip-pointer").bgiframe();
//修复IE6.0下提示标签，被select框挡住BUG End
...
//表格高度最小高度（仅有一行时）41像素，
_397.height(_399>41?_399:41);
_398.height(_399>41?_399:41);
//表格高度最小高度（仅有一行时）41像素，
...
//add by hxw support IE6.0
var tool=($.browser.msie && $.browser.version=='6.0')?$("<a href=\"#\"></a>"): $("<a href=\"javascript:void(0)\"></a>");//原来代码 var tool=$("<a href=\"javascript:void(0)\"></a>");
//add by hxw support IE6.0
...
}}/*,datebox:{init:function(_4b9,_4ba){////1.2.1
