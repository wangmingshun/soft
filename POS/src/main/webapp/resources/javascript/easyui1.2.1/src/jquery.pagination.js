...
(function($){
	function buildToolbar(target){
		...
		$('<td><a href="javascript:void(0)" id="pagination-first" icon="pagination-first"></a></td>').appendTo(tr);
		$('<td><a href="javascript:void(0)" id="pagination-prev" icon="pagination-prev"></a></td>').appendTo(tr);
		$('<td><div class="pagination-btn-separator"></div></td>').appendTo(tr);
...
//				.html(opts.afterPageText)
		...
		$('<td><div class="pagination-btn-separator"></div></td>').appendTo(tr);
		$('<td><a href="javascript:void(0)" id="pagination-next" icon="pagination-next"></a></td>').appendTo(tr);
		$('<td><a href="javascript:void(0)" id="pagination-last" icon="pagination-last"></a></td>').appendTo(tr);
