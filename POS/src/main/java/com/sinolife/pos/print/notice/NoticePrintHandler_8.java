 ...
 * 8 险种满期通知书
 */
@Component("NoticePrintHandler_8")
public class NoticePrintHandler_8 extends NoticePrintHandlerBase {

	@Override
	public InputStream getTempleteInputStream(Object posNote) throws IOException {
		return this.templateStore.getTemplateStream("POS", "print", "notice_8_" + ((PosNoteDTO)posNote).getTemplateVersion());
	}

	@Override
	public String getFileName(String key) {
		if(StringUtils.isNotBlank(key)) {
			return "险种满期通知书-" + key + ".pdf";
		} else {
			return "险种满期通知书-" + getTimeString() + ".pdf";
		}
	}
