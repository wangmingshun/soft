 ...
 * 7 保单贷款即将逾期提醒函
 */
@Component("NoticePrintHandler_7")
public class NoticePrintHandler_7 extends NoticePrintHandlerBase {

	@Override
	public InputStream getTempleteInputStream(Object posNote) throws IOException {
		return this.templateStore.getTemplateStream("POS", "print", "notice_7_" + ((PosNoteDTO)posNote).getTemplateVersion());
	}

	@Override
	public String getFileName(String key) {
		if(StringUtils.isNotBlank(key)) {
			return "保单贷款即将逾期提醒函-" + key + ".pdf";
		} else {
			return "保单贷款即将逾期提醒函-" + getTimeString() + ".pdf";
		}
	}
